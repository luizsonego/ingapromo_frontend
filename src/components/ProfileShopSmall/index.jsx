...
const ProfileShop = ({ data, category, count }) => {
  return (
    <div className="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6  2xl:px-20 md:px-6 px-4">
      ...
      <div className="flex flex-col px-6">
        <div className="flex h-8 flex-row">
          <Link to={`/loja/${data.id}`} target="_blank" rel="noreferrer">
        ...
        <div className="mt-2 flex flex-row items-center space-x-5">
          ...
          >
            ...
            <div className="mt-2 text-sm text-gray-400">Cupons cadastrados</div>
          </Link>
        </div>
      </div>
    </div>
