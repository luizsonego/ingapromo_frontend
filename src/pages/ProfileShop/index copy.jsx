  ...
  return (
    <main className="container mx-auto pt-12">
      <div className="flex flex-col lg:flex-row gap-2">
        <div className="mt-6 lg:mt-0 lg:w-2/6  rounded-xl">
          <div className="flex flex-row p-6 mx-5 rounded-xl shadow-md border  bg-white">
            <div className="relative">
              {!storeDetails?.imageThumbnailUrl ? (
                <img
                  className="w-32 h-32 rounded-full object-cover"
                  src="https://media.cuponeria.com.br/store/netshoes/logo/46824982-netshoes-100x100-72x72.webp"
                ...
                <img
                  ...
                  src={storeDetails?.imageThumbnailUrl}
                  alt="User"
                />
              )}
            </div>
