        ...
        <div className="md:flex">
          ...
          <div className=" w-full md:w-4/5 px-3 md:px-0 pb-3 md:pb-1 mt-0 md:mt-5 md:ml-3">
            <h2 className="text-xl md:text-2xl text-gray-700 font-semibold text-center md:text-left">
              {storeDetails?.name} {/* //ICONE VERIFICADO */}
              <Link to={`/categoria/${storeDetails?.category}`}>
                <small className="text-sm">{storeDetails?.category}</small>
              </Link>
            </h2>
            ...
            <div className="flex md:flex-row flex-col gap-4 mt-3">
              <div className="text-xs text-gray-400/80 hover:text-gray-400">
                {storeDetails.address}, {storeDetails.number}
              </div>
              <div className="text-xs text-gray-400/80 hover:text-gray-400">
                {storeDetails.district}, {storeDetails.city} -{' '}
                {storeDetails.state}
              </div>
            </div>
            ...
            <div className="flex md:flex-row flex-col gap-4 mt-3">
              <div className="text-xs text-gray-400/80 hover:text-gray-400">
                {storeDetails.facebook}
              </div>
              <div className="text-xs text-gray-400/80 hover:text-gray-400">
                {storeDetails.instagram}
              </div>
              <div className="text-xs text-gray-400/80 hover:text-gray-400">
                {storeDetails.twitter}
              </div>
            </div>
          </div>
        </div>
